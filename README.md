# TBA
The idea behind XXX is to visualise a mordern game of survival of the fitest. Two systems are comparing each other on a fixed grit. 
...
2. RUN BOTH BOT SCRPITS & WAIT UNTIL BOTH BOTS TRADED AT LEAST 50x (OTHERWISE ADJUST THE ARRAY IN THE GRIT FILE)
3. RUN GRIT.ipynb
